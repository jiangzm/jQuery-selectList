...
(function ($) {
    ...
    function setIndexes(indexes) {
        ...
        if (!indexes || indexes.length == 0) {
            ...
            setText.call(target, opts.emptyText);
        ...
        setText.call(target, ss.join(opts.separator) || opts.emptyText);
    ...
    function showPanel() {
        ...
        opts.multiple && (function () {
            ...
            if (data.length == panel.find(":checked").length) {
                opts.selectAll = true;
                panel.find(".allButton").text(opts.clearText);
            }
            else {
                opts.selectAll = false;
                panel.find(".allButton").text(opts.allText);
            }
        })();
